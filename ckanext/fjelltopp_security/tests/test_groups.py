...
class TestSecureGroupActions:
    ...
    class TestSecureGroupAPI:

        def test_api_group_create_with_external_image(self, _call_api, _assert):
            ...
            _assert(
                _call_api(group_dict, 'group_create', True),
                False
            )

        def test_api_group_update_with_external_image(self, _call_api, _assert):
            ...
            _assert(
                _call_api(update_dict, 'group_update', True),
                False
            )

        def test_api_group_update_with_valid_image(self, _call_api, _assert):
            ...
            _assert(
                _call_api(update_dict, 'group_update'),
                True,
                '/images/updated-image.jpg'
            )

        def test_api_group_create_with_valid_image(self, _call_api, _assert):
            ...
            _assert(
                _call_api(group_dict, 'group_create'),
                True
            )

        def test_api_group_create_without_image(self, _call_api, _assert):
        ...
        def test_api_group_update_remove_image(self, _call_api, _assert):
